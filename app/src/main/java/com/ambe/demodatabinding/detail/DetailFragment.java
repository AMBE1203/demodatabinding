...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TaskEntity  taskEntity = bundle.getParcelable("task");

        taskRepository = TaskRepository.getInstance(TaskLocalDataSource.getInstance(MyDatabase.getInstance(getActivity()).taskDAO()));
